...
namespace SolarSystem.Module.Astre
{
    public class Planet
    {
        ...
        {
            int add = 10;
            GParams.spriteBatch.DrawString(font, "Position: " + position, stringPos + new Vector2(0, 10), Color.White);
            GParams.spriteBatch.DrawString(font, "Mass : " + mass, stringPos + new Vector2(0, 20), Color.White);
            GParams.spriteBatch.DrawString(font, "Mass : " + mass, stringPos + new Vector2(0, 30), Color.White);
