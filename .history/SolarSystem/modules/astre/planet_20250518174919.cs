...
namespace SolarSystem.Module.Astre
{
    public class Planet
    {
        ...
        {
            int add = 40;
            GParams.spriteBatch.DrawString(font, "Planet name : " + name, stringPos + new Vector2(0, add), Color.White);
            GParams.spriteBatch.DrawString(font, "Position: " + position, stringPos + new Vector2(0, add*2), Color.White);
            GParams.spriteBatch.DrawString(font, "Mass : " + mass, stringPos + new Vector2(0, add * 3), Color.White);
            GParams.spriteBatch.DrawString(font, "Distance : " + GetDistance(Vector2.Zero), stringPos + new Vector2(0, add * 4), Color.White);
            GParams.spriteBatch.DrawString(font, "Direction : " + GetDirection(Vector2.Zero), stringPos + new Vector2(0, add * 5), Color.White);
        }
